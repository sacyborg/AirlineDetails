...
<body>
	...
	<div id="mySidenav" class="sidenav">
		...
		<a href='TicketDisplayController?profile=profile'>Profile
			Information</a> <a href='TicketDisplayController?profile=booking'>Your
			Booking details</a> <a href='TicketDisplayController?profile=information'>Your
			Information</a> <a href='TicketDisplayController?profile=cupons'>Cupons</a>



		<a href="#">Contact</a> <a
			href='TicketDisplayController?profile=logout'>Logout</a>
						...
						<form action="FlightController" method="post">
									...
									<div class="textfield-search one-third " align="center">
										...
										<div class="form-group" align="center">
											...
											<label style="color: white">Source</label> <select
												align="center" class="form-control" id="source"
												name="source">
							...
							<div class="row">
								...
								<div class="form-btn">
									...
									<input type="submit" class="submit-btn" name="Flights"
										value="Flights">
